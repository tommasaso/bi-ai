 ...
 * ```
 */
export declare function registerCommand(command: Command, callback: (...args: any[]) => any, thisArg?: any): Disposable;
/**
 ...
 */
export declare function executeCommand<T = unknown>(command: string, ...rest: any[]): Promise<T>;
/**
