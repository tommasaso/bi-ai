 ...
 */
export declare enum ThemeAlgorithm {
    DEFAULT = "default",
    DARK = "dark",
    COMPACT = "compact"
}
 ...
 */
export type ThemeAlgorithmOption = ThemeAlgorithm.DEFAULT | ThemeAlgorithm.DARK | ThemeAlgorithm.COMPACT | ThemeAlgorithm[];
/**
